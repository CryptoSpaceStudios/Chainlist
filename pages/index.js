...
function Home({ changeTheme, theme }) {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Chainlist  is a list of EVM networks</title>
        ...
        <meta property="og:title" content="Chainlist  is a list of EVM networks" />
          ...
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              ...
              <div className={ classes.socials }>
                <a className={ `${classes.socialButton}` } href='https://github.com/CryptoSpaceStudios/Chainlist.git' target='_blank' rel="noopener noreferrer" >
